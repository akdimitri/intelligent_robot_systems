    ...
    def readMap(self, data):
        ...
        for i in range(-20, 20):
            for j in range(-20, 20):
                # Fixed Index Bug edit: Dimitrios Antoniadis date: 22/01/2020
                # if self.ogm[xx + i, yy + j] > 49 or self.ogm[xx + i, yy + j] == -1:                       # Line Removed edit: Dimitrios Antoniadis date: 22/01/2020
                if self.ogm[int(xx + i), int(yy + j)] > 49 or self.ogm[int(xx + i), int(yy + j)] == -1:     # Line Added edit: Dimitrios Antoniadis date: 22/01/2020
                    continue
                # self.coverage[xx + i, yy + j] = 100                                                       # Line Removed edit: Dimitrios Antoniadis date: 22/01/2020
                self.coverage[int(xx + i), int(yy + j)] = 100                                               # Line Added edit: Dimitrios Antoniadis date: 22/01/2020
